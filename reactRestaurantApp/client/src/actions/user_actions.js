...
import { USER_SERVER, MENU_SERVER } from "../components/utils/misc";
...
export function addToCart(_id) {
  const request = axios
    .post(`${USER_SERVER}/addToCart?menuItemId=${_id}`)
    .then((response) => response.data);
...
export function getCartItems(cartItems, userCart) {
  const request = axios
    .get(`${MENU_SERVER}/items_by_id?id=${cartItems}&type=array`)
    .then((response) => {
